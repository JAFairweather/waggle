...
const response = (status, value) => ({ status, body: null, text: async () => JSON.stringify(value) })
...

{
  ...
  t('authoritative refusal is terminal and cannot claim publication', refused.result === 'refused' && fields.reason_code === 'buzz-refused' && fields.buzz_event_id === null)
}
