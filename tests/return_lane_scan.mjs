...
async function scanDelta(msgs, opts) {
  ...
  // Working-channel input is a real signed Buzz kind:9 event. JSON round-trip strips the
  // finalizeEvent verification symbol so production signature verification is genuinely run.
