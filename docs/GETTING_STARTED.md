...
- **Run the safety gates before you ship:** `npm test` — 110 suites driving the real
  routing functions with synthetic events (no production state, no network; one loopback TLS
  socket), all green.
