...
`npm test` — 67 suites, against the real exported functions with synthetic events. No sockets,
...
CI runs them on push and PR. **If a run reports fewer than 67, the branch is on a stale base.**
