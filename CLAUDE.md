...
`npm test` — 104 suites, against the real exported functions with synthetic events. No sockets,
...
CI runs them on push and PR. **If a run reports fewer than 104, the branch is on a stale base.**
