...
`npm test` — 111 suites, against the real exported functions with synthetic events. No production
...
CI runs them on push and PR. **If a run reports fewer than 111, the branch is on a stale base.**
