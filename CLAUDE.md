...
`npm test` — 114 suites, against the real exported functions with synthetic events. No production
...
CI runs them on push and PR. **If a run reports fewer than 114, the branch is on a stale base.**
